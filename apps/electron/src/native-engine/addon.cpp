...
rawelectron::image_core::Adjustment ReadEditParams(napi_env env, napi_value request) {
  ...
  params.red_hue = GetDoubleProperty(env, value, "redHue");
  params.red_saturation = GetDoubleProperty(env, value, "redSaturation");
  params.green_hue = GetDoubleProperty(env, value, "greenHue");
  params.green_saturation = GetDoubleProperty(env, value, "greenSaturation");
  params.blue_hue = GetDoubleProperty(env, value, "blueHue");
  params.blue_saturation = GetDoubleProperty(env, value, "blueSaturation");
  params.shadow_hue = GetDoubleProperty(env, value, "shadowHue");
  params.shadow_saturation = GetDoubleProperty(env, value, "shadowSaturation");
  params.midtone_hue = GetDoubleProperty(env, value, "midtoneHue");
  params.midtone_saturation = GetDoubleProperty(env, value, "midtoneSaturation");
  params.highlight_hue = GetDoubleProperty(env, value, "highlightHue");
  params.highlight_saturation = GetDoubleProperty(env, value, "highlightSaturation");
  params.color_grading_blending = GetDoubleProperty(env, value, "colorGradingBlending", 50.0);
  params.color_grading_balance = GetDoubleProperty(env, value, "colorGradingBalance");
  ...
  params.vignette_midpoint = GetDoubleProperty(env, value, "vignetteMidpoint", 50.0);
  params.vignette_roundness = GetDoubleProperty(env, value, "vignetteRoundness");
  params.vignette_feather = GetDoubleProperty(env, value, "vignetteFeather", 50.0);
  params.vignette_highlights = GetDoubleProperty(env, value, "vignetteHighlights");
  params.grain = GetDoubleProperty(env, value, "grain");
  params.grain_size = GetDoubleProperty(env, value, "grainSize", 25.0);
  params.grain_roughness = GetDoubleProperty(env, value, "grainRoughness", 50.0);
  params.sharpening = GetDoubleProperty(env, value, "sharpening");
  params.sharpening_radius = GetDoubleProperty(env, value, "sharpeningRadius", 1.0);
  params.sharpening_detail = GetDoubleProperty(env, value, "sharpeningDetail", 25.0);
  params.sharpening_masking = GetDoubleProperty(env, value, "sharpeningMasking");
  params.luminance_noise = GetDoubleProperty(env, value, "luminanceNoise");
  params.luminance_noise_detail = GetDoubleProperty(env, value, "luminanceNoiseDetail", 50.0);
  params.luminance_noise_contrast = GetDoubleProperty(env, value, "luminanceNoiseContrast");
  params.color_noise = GetDoubleProperty(env, value, "colorNoise");
  params.color_noise_detail = GetDoubleProperty(env, value, "colorNoiseDetail", 50.0);
  params.color_noise_smoothness = GetDoubleProperty(env, value, "colorNoiseSmoothness", 50.0);
