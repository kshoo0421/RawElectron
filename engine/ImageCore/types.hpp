...
struct Adjustment {
  ...
  double red_hue = 0.0;
  double red_saturation = 0.0;
  double green_hue = 0.0;
  double green_saturation = 0.0;
  double blue_hue = 0.0;
  double blue_saturation = 0.0;
  double shadow_hue = 0.0;
  double shadow_saturation = 0.0;
  double midtone_hue = 0.0;
  double midtone_saturation = 0.0;
  double highlight_hue = 0.0;
  double highlight_saturation = 0.0;
  double color_grading_blending = 50.0;
  double color_grading_balance = 0.0;
  double texture = 0.0;
  double clarity = 0.0;
  double dehaze = 0.0;
  double vignette = 0.0;
  double vignette_midpoint = 50.0;
  double vignette_roundness = 0.0;
  double vignette_feather = 50.0;
  double vignette_highlights = 0.0;
  double grain = 0.0;
  double grain_size = 25.0;
  double grain_roughness = 50.0;
  double sharpening = 0.0;
  double sharpening_radius = 1.0;
  double sharpening_detail = 25.0;
  double sharpening_masking = 0.0;
  double luminance_noise = 0.0;
  double luminance_noise_detail = 50.0;
  double luminance_noise_contrast = 0.0;
  double color_noise = 0.0;
  double color_noise_detail = 50.0;
  double color_noise_smoothness = 50.0;
  double moire = 0.0;
  double defringe = 0.0;
