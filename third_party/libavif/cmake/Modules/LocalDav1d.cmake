...
function(avif_build_local_dav1d)
    ...
    if(DEFINED RAWELECTRON_DAV1D_ROOT AND EXISTS "${RAWELECTRON_DAV1D_ROOT}/meson.build")
        message(STATUS "libavif(AVIF_CODEC_DAV1D=LOCAL): using RAWELECTRON_DAV1D_ROOT")
        set(source_dir "${RAWELECTRON_DAV1D_ROOT}")
    elseif(EXISTS "${AVIF_SOURCE_DIR}/ext/dav1d")
    ...
    if(NASM_EXECUTABLE OR NOT CMAKE_SYSTEM_PROCESSOR MATCHES "^(x86_64|AMD64|i.86)$")
        ...
        message(WARNING "NASM was not found; dav1d will build without assembly optimizations")
    endif()
